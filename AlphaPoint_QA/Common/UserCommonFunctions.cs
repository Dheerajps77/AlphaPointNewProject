...
namespace AlphaPoint_QA.Common
{
    ...
    class UserCommonFunctions
    {
        ...
        static By depositOrder = By.XPath("//div[@class='ap-tab__menu order-history__menu']//div[@data-test='Deposit Status']");
        static By withdrawOrder = By.XPath("//div[@class='ap-tab__menu order-history__menu']//div[@data-test='Withdraw Status']");
