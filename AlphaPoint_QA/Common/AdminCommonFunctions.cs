...
namespace AlphaPoint_QA.Common
{
    public class AdminCommonFunctions
    {
        ...
        By createUserAffiliateTagButton = By.XPath("//button[@id='OpenCreateUserAffiliateTag']");
        ...
        By affiliateTagAddedText = By.XPath("//td[@class='subtitle' and text()='Affiliate Tag']//following::div[1]//span");
        By usersList = By.XPath("//div[@class='ReactVirtualized__Grid__innerScrollContainer']/div");
