...
namespace AlphaPoint_QA.Pages
{
    class AdvancedOrderPage
    {
        ...
        By limitOffset = By.XPath("//input[@data-test='Limit Offset:']");
        By timeInForce = By.XPath("//div[@class='form-group ap-select__select-wrapper advanced-order-form__select-wrapper']//select[@name='timeInForce']");
